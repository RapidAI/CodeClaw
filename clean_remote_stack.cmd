...
echo.
echo Cleaning local CodeClaw remote stack state...
echo.
...
if exist "%HUB_DIR%\data\codeclaw-hub.db" del /f /q "%HUB_DIR%\data\codeclaw-hub.db" >nul 2>nul
if exist "%HUB_DIR%\data\codeclaw-hub.db-shm" del /f /q "%HUB_DIR%\data\codeclaw-hub.db-shm" >nul 2>nul
if exist "%HUB_DIR%\data\codeclaw-hub.db-wal" del /f /q "%HUB_DIR%\data\codeclaw-hub.db-wal" >nul 2>nul

echo Removing Hub Center data files...
if exist "%HUBCENTER_DIR%\data\codeclaw-hubcenter.db" del /f /q "%HUBCENTER_DIR%\data\codeclaw-hubcenter.db" >nul 2>nul
if exist "%HUBCENTER_DIR%\data\codeclaw-hubcenter.db-shm" del /f /q "%HUBCENTER_DIR%\data\codeclaw-hubcenter.db-shm" >nul 2>nul
if exist "%HUBCENTER_DIR%\data\codeclaw-hubcenter.db-wal" del /f /q "%HUBCENTER_DIR%\data\codeclaw-hubcenter.db-wal" >nul 2>nul
...
echo.
echo [OK] Local CodeClaw remote stack state cleaned.
echo.
echo Next:
