...
func newAdminRouterTestServices(t *testing.T) (http.Handler, *auth.AdminService) {
	...
	router := NewRouter(admins, identity, centerSvc, nil, gateway, deviceSvc, sessionSvc, nil, st.EmailInvites, st.System, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "", nil, "", "/app", "")
