...
// cleanly on IM platforms that don't render Markdown (plain-text channels,
// progress messages, combined broadcast replies, etc.).
//
// Handled patterns:
...
func stripMarkdown(text string) string {
	...
	// Bold: **text** or __text__ (two separate passes to avoid group mismatch)
