...
func (d *testDeviceBinder) MarkOnline(ctx context.Context, machineID string) error {
    d.markedOnline++
    return nil
}

func (d *testDeviceBinder) Heartbeat(ctx context.Context, machineID string) error {
    d.heartbeats++
    return nil
}
