...
// ClaudeSummaryReducer updates a SessionSummary based on events and raw lines.
type ClaudeSummaryReducer struct{}

// NewClaudeSummaryReducer creates a new reducer.
func NewClaudeSummaryReducer() *ClaudeSummaryReducer {
	return &ClaudeSummaryReducer{}
}

// Apply implements SummaryReducer.
