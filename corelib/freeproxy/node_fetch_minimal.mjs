// Minimal Node.js test: sign with browser-sim WASM + send with native fetch
// This isolates whether the issue is signing or transport
...
try {
    ...
    console.error('Cannot load cookies:', e.message);
    process.exit(1);
}
...
if (!convId) { console.error('No conversationId'); process.exit(1); }
...
// === Send with fetch - matching browser headers EXACTLY ===
console.log('\n=== Sending v2/chat via Node.js fetch ===');
