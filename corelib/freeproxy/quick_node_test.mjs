// Quick test: Node.js WASM sign + fetch to verify if signing produces valid results
...
if (!createData.success) { console.error('Create failed:', createData); process.exit(1); }
const convId = createData.data.conversationId;
console.log('ConversationID:', convId);

// Step 2: Sign and send chat request
...
console.log('\nSending chat request via fetch...');
