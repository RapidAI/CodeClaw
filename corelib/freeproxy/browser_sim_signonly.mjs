// Browser-simulated WASM signing ONLY (no network request)
// Outputs JSON: {"sign":"...","nonce":"...","timestamp":...}
// Usage: node browser_sim_signonly.mjs <body> <url>
...
// Output ONLY the JSON result (no debug logs)
